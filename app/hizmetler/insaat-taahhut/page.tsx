...
const service = services.find(s => s.slug === 'insaat-taahhut')!;

const faqs = [
  { q: "Anahtar teslim taahhüt neleri kapsar?", a: "Proje, ruhsat, kaba inşaat, tesisat, kaplama ve ince işçilik dahil tüm imalatlar tek sözleşmede toplanır. Siz sadece anahtarı teslim alırsınız." },
  { q: "Kaba inşaat ne kadar sürer?", a: "Villa ölçeğinde kaba inşaat ortalama 45-75 gün sürer. Zemin, kat yüksekliği ve hava koşullarına göre iş programı netleştirilir." },
  { q: "Taahhütte fiyat artışı olur mu?", a: "Sözleşmede yazan metraj ve malzeme dışında ek iş çıkmadıkça fiyat sabittir. Sürpriz maliyet yansıtılmaz." },
  { q: "Proje yönetimi nasıl yapılır?", a: "Şantiye şefi, günlük rapor ve haftalık ilerleme toplantısı ile süreç şeffaf yürütülür. Hakedişler iş programına göre düzenlenir." },
];
    ...
    <div className="min-h-screen bg-zinc-50 text-zinc-900 antialiased font-sans">
      <section className="relative bg-gradient-to-br from-[#2d3140] via-[#353a4e] to-[#1e2133] text-white overflow-hidden py-16 sm:py-20 border-b-4 border-amber-500">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-amber-500 text-zinc-950 text-[10px] font-black uppercase tracking-widest mb-2">★ Öne Çıkan — Taahhüt</span>
              <h1 className="text-4xl sm:text-5xl font-black tracking-tight">{service.title}</h1>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-[#2d3140] to-[#1e2133] text-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-black uppercase tracking-wide">Taahhüt Teklifinizi Alın</h2>
          <p className="mt-4 text-zinc-300 text-sm">Projenizi anlatın, metrajlı keşif ve yazılı taahhüt ile net teklif sunalım.</p>
