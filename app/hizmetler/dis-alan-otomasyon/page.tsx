...
const service = services.find(s => s.slug === 'dis-alan-otomasyon')!;

const faqs = [
  { q: "Garaj kapısı motoru her kapıya uyumlu mudur?", a: "Hayır, kapınızın tipine ve ağırlığına uygun motor seçimi önemlidir. Seksiyonel, panel veya sürgülü kapılar için farklı motor tipleri kullanılır. Keşif sonrası size en uygun sistemi öneriyoruz." },
  { q: "Pergole ahşap mı alüminyum mu daha dayanıklı?", a: "Alüminyum pergoleler paslanmaz, hafif ve az bakım gerektirir. Ahşap pergoleler ise doğal görünüm sunar ancak düzenli bakım ister. Her iki malzeme de uzun ömürlüdür, tercihiniz estetik beklentinize bağlıdır." },
  { q: "Ferforje korkuluklar paslanır mı?", a: "Dövme demir ferforje paslanmaya karşı koruyucu boya ile kaplanır. Düzenli bakım yapıldığında uzun yıllar paslanma sorunu yaşanmaz. İsteğe bağlı olarak paslanmaz çelik veya alüminyum alternatifler de sunuyoruz." },
  { q: "Çit yüksekliği için herhangi bir sınırlama var mı?", a: "İmar yönetmeliklerine göre ön bahçe çitleri genellikle 1.5 metreyi geçemez. Yan ve arka bahçelerde 2-2.5 metreye kadar çit yapılabilir. Kesin ölçüler için yerel belediye yönetmeliğini kontrol etmek gerekir." },
];

export default function DisAlanOtomasyonPage() {
