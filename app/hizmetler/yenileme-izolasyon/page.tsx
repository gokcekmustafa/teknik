...
const service = services.find(s => s.slug === 'yenileme-izolasyon')!;

const faqs = [
  { q: "Seramik döşeme mi ahşap laminant mı önerirsiniz?", a: "Seramik, mutfak ve banyo gibi ıslak alanlar için idealdir. Laminant parke ise salon ve odalar için daha sıcak bir görünüm sunar. İhtiyacınıza ve bütçenize göre en uygun malzemeyi öneriyoruz." },
  { q: "Mantolama yaptırmak enerji faturasında ne kadar tasarruf sağlar?", a: "Doğru uygulanan bir dış cephe mantolama ile ısıtma ve soğutma giderlerinizde %30-50 arası tasarruf sağlayabilirsiniz. Ayrıca yazın iç ortam sıcaklığını 3-5°C düşürür." },
  { q: "Çatı izolasyonu ne kadar sürede tamamlanır?", a: "Çatının büyüklüğüne ve işin kapsamına göre 2-7 gün arasında değişir. Kiremit aktarma, membran uygulaması ve izolasyon işlemleri bu süreye dahildir." },
  { q: "Boya işi öncesi eski boyalar kazınmalı mı?", a: "Eski boya kabarmış, kalkmış veya dökülüyorsa mutlaka kazınmalı ve yüzey yeniden hazırlanmalıdır. Sağlam yüzeylerde ise zımpara ve astar uygulaması yeterlidir." },
];

export default function YenilemeIzolasyonPage() {
