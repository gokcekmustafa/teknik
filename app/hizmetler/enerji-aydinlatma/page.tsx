...
const service = services.find(s => s.slug === 'enerji-aydinlatma')!;

const faqs = [
  { q: "Elektrikli araç şarj istasyonu için hangi izinler gerekli?", a: "Müstakil evler için genellikle ek izin gerekmez. Apartmanlarda yönetim onayı ve elektrik dağıtım şirketine başvuru gerekebilir. Tüm prosedürler konusunda danışmanlık sağlıyoruz." },
  { q: "Bahçe aydınlatması ne kadar sürede kurulur?", a: "Bahçenin büyüklüğüne ve aydınlatma noktası sayısına bağlı olarak 1-3 gün içinde montaj tamamlanır. Altyapı çalışmaları da bu süreye dahildir." },
  { q: "Aydınlatma sistemleriniz için garanti veriyor musunuz?", a: "Evet, tüm malzeme ve işçilik için 2 yıl garantili hizmet sunuyoruz. Arıza durumunda ek ücret talep edilmez." },
  { q: "LED dönüşümü ile ne kadar tasarruf sağlarım?", a: "Eski tip armatürlerden LED'e geçişte %50-80 arası enerji tasarrufu sağlayabilirsiniz. Ayrıca LED'ler 5-10 kat daha uzun ömürlüdür." },
];

export default function EnerjiAydinlatmaPage() {
